...
function images = SHINE_matchtoStats(images,templ,stats)
...
background = 0; % background lum of template, or 300=automatic (default)
...
for iteration = 1:it
    ...
    switch mode
        case 1
            if wholeIm == 1
                images = lumMatch(images,[], [stats.meanLum stats.meanStd]);
            else
                images = lumMatch(images,mask_fgr, [stats.meanLum stats.meanStd]);
                images = lumMatch(images,mask_bgr, [stats.meanLum 0]);
            end
        ...
        case {2, 5, 6}
            if wholeIm == 1
                ...
                images = histMatch(images,optim,stats.histMat,mask_fgr);
